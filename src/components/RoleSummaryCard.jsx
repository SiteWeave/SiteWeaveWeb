    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center h-full min-h-[100px]">
          ...
          <p className="text-xs font-semibold text-gray-700">{t('team.create_custom_role')}</p>
        </div>
      </div>
    );
  }
    ...
    >
              ...
              <>
                ...
                {onDelete && (
                  <button
                    ...
                    title={t('team.delete_role')}
                    aria-label={t('team.delete_role')}
                  >
      ...
      <div className="mt-1">
        ...
        <p className="text-xs text-gray-500 mt-0.5">
          {t(memberCount === 1 ? 'team.user_one' : 'team.user_other', { count: memberCount })}
        </p>
      </div>
    </div>
  );
